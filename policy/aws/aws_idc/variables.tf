...
variable "policy_name" {
  ...
  type        = string
  default     = "terraform-aws-idc-example"
}
...
variable "identity_svc_acct_aws_name"{
  description = "name of the secret in AWS secrets manager to be used for creating policy in CyberArk"
  type        = string
}

variable "username_domain"{
  description = "domain name to append to the service account username"
  type = string
}
